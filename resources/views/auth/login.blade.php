                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" type=" email" id="emailaddress" value="{{ old('email') ?  old('email') : ''}}" name="email" placeholder="Enter your email">
                            @error('email')
                        ...
                        <div class="form-group mb-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }} class="custom-control-input" id="checkbox-remember">
